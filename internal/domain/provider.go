...
//go:generate mockgen -destination=provider_mock.go -package=domain github.com/flight-search/flight-search-and-aggregation-system/internal/domain FlightProvider,ProviderRegistry
